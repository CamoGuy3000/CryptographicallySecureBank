...
def add_round_key(state, key):
  ...
  # num_state = [s for s in state]
  return [(s ^ k) for s, k in zip(state, key)]


def format_input(in_ptxt: list[str], key):
  ptxt = []
  for i in in_ptxt:
    ptxt.append(int(i, 2))
  offset = len(ptxt)
  # print(ptxt, offset)
  while len(ptxt)%16 != 15:
    rand = randbits(8)
    ptxt.append(rand)
  ptxt.append(offset)
  # print(ptxt, len(ptxt))
...
def aes_encrypt(ptxt: list[str], key: list[str]):
  ...
  # print(state, fkey)
  state = add_round_key(state, fkey)
...
def aes_decrypt(ctxt, in_key, r):
  # format_input(ctxt, key)
  key = []
  for i in in_key:
    key.append(int(i,2))
  rounds = 10
...
# format_input(["01101001", "01001101", "01001011"])
# format_input(["01101001", "01001101", "01001011","01101001", "01001101", "01001011","01101001", "01001101", "01001011","01101001", "01001101", "01001011","01101001", "01001101", "01001011","01101001", "01001101", "01001011","01101001", "01001101", "01001011"])
